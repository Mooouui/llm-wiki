...
title: "Hormesis"
type: concept
tags: [cognitive-science, learning, critique]
...
When you struggle to express a difficult idea in your own words, the moment your sentence breaks down because you realize you don't truly understand — **that breakdown is the most valuable moment in the entire process**. It is the signal that real cognitive integration is happening.

> "一个作家在试图用自己的话表达一个困难想法时遇到的摩擦是 hormetic 的。它不是思考过程中的 bug——它是思考的机制。"

## Extended Brain's Fitness Analogy
...
- Use LLM for scaffolding (linking, indexing, gap-finding) — the map
- Keep synthesis to yourself — walk the territory
- Let LLM *discover* tensions but not *resolve* them prematurely
